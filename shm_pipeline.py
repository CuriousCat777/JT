...
def skill_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "skills": [
            ...
            {
                "name": "get_extracts",
                "description": "Query processed PDF extracts",
                "params": {"domain": "tag filter", "evidence_level": "level filter"},
                "returns": "list of PDFExtract objects",
            },
            {
                "name": "export_payload",
                "description": "Generate handoff payload with pipeline data",
                "params": {"role": "researcher|builder|auditor|full"},
                "returns": "structured payload string",
            },
            {
                "name": "collect_online",
                "description": "Run one online collection cycle",
                "params": {"topics": "optional topic list override"},
                "returns": "list of OnlineResult objects",
            },
        ],
        "daemon_modes": ["online_collector"],
        "data_sources": ["pubmed", "shm", "guidelines", "cms"],
