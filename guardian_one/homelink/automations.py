...
def _default_rules() -> list[AutomationRule]:
    """Chronos-driven automations for Jeremy's Duluth residence."""
    return [
        # --- Morning / Wake ---
        AutomationRule(
        ...
        AutomationRule(
            ...
            description="Turn on living room lights at wake — Govee warm + Hue spots",
            trigger_type=TriggerType.SCHEDULE,
            trigger_config={"event": "wake"},
            actions=[
                AutomationAction(
        ...
        AutomationRule(
            rule_id="auto-wake-office",
            name="Morning — Office Ready",
            description="Turn on office desk light and fairy lights for work",
            trigger_type=TriggerType.SCHEDULE,
            trigger_config={"event": "wake"},
            actions=[
                AutomationAction(
                    action_type=ActionType.DEVICE_ON,
                    target_device_id="plug-kasa-office-desk",
                ),
                AutomationAction(
                    action_type=ActionType.DEVICE_ON,
                    target_device_id="plug-kasa-fairy-office",
                ),
                AutomationAction(
                    action_type=ActionType.LIGHT_ON,
        ...
        AutomationRule(
            ...
            description="Close Ryse blinds when Chronos fires sleep event",
            trigger_type=TriggerType.SCHEDULE,
        ...
        AutomationRule(
            ...
            name="Night — All Lights Off",
            description="Turn off all lights house-wide when going to sleep",
            trigger_type=TriggerType.SCHEDULE,
            trigger_config={"event": "sleep"},
            actions=[
                AutomationAction(action_type=ActionType.LIGHT_OFF,
                                 target_room_id="living-room"),
                AutomationAction(action_type=ActionType.LIGHT_OFF,
                ...
                AutomationAction(action_type=ActionType.LIGHT_OFF,
                                 target_room_id="guest-bathroom"),
                AutomationAction(action_type=ActionType.LIGHT_OFF,
                                 target_room_id="master-bathroom"),
                AutomationAction(action_type=ActionType.LIGHT_OFF,
        ...
        AutomationRule(
            rule_id="auto-sleep-plugs",
            name="Night — Non-essential Plugs Off",
            description="Turn off console, island, and desk plugs at bedtime",
            trigger_type=TriggerType.SCHEDULE,
            trigger_config={"event": "sleep"},
            actions=[
                AutomationAction(action_type=ActionType.DEVICE_OFF,
                                 target_device_id="plug-kasa-console"),
                AutomationAction(action_type=ActionType.DEVICE_OFF,
                                 target_device_id="plug-kasa-island"),
                AutomationAction(action_type=ActionType.DEVICE_OFF,
                                 target_device_id="plug-kasa-office-desk"),
                AutomationAction(action_type=ActionType.DEVICE_OFF,
                                 target_device_id="plug-kasa-fairy-office"),
            ...
            priority=3,
            tags=["night", "chronos", "energy"],
        ),
        AutomationRule(
            rule_id="auto-sleep-cameras",
            name="Night — Arm Cameras",
            description="Arm Ring doorbell camera when going to sleep",
            trigger_type=TriggerType.SCHEDULE,
            trigger_config={"event": "sleep"},
            actions=[
                AutomationAction(action_type=ActionType.CAMERA_ARM,
        ...
        AutomationRule(
            ...
            name="Away — Full Lockdown",
            description="When leaving: arm cameras, close blinds, all lights/plugs off",
            trigger_type=TriggerType.SCHEDULE,
        ...
        AutomationRule(
            ...
            description="Arriving: open blinds, warm lights on, disarm entry camera",
            trigger_type=TriggerType.SCHEDULE,
            trigger_config={"event": "arrive"},
            actions=[
                AutomationAction(action_type=ActionType.BLIND_OPEN,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(
                    action_type=ActionType.LIGHT_ON,
                    target_room_id="living-room",
                ...
                AutomationAction(action_type=ActionType.CAMERA_DISARM,
                                 target_device_id="cam-01"),
            ],
            priority=1,
            tags=["arrive", "chronos"],
...
def _default_scenes() -> list[Scene]:
    """Named presets for quick activation — Jeremy's actual rooms."""
    return [
        Scene(
            scene_id="scene-movie",
            name="Movie Mode",
            description="Close blinds, dim Govee to warm 10%, DreamView on, TV on",
            actions=[
                AutomationAction(action_type=ActionType.BLIND_CLOSE,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(
                ...
                AutomationAction(action_type=ActionType.DEVICE_ON,
                                 target_device_id="tv-main"),
            ],
            room_id="living-room",
        ...
        Scene(
            scene_id="scene-work",
            name="Focus Mode",
            description="Office bright daylight, desk + fairy on, TV off, blinds open",
            actions=[
                AutomationAction(action_type=ActionType.BLIND_OPEN,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(
        ...
        Scene(
            scene_id="scene-away",
            name="Away Mode",
            description="Everything off, cameras armed, blinds closed — full lockdown",
            actions=[
                AutomationAction(action_type=ActionType.BLIND_CLOSE,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(action_type=ActionType.LIGHT_OFF,
        ...
        Scene(
            ...
            name="Goodnight",
            description="Full shutdown — sleep mode for the entire home",
            actions=[
                AutomationAction(action_type=ActionType.BLIND_CLOSE,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(action_type=ActionType.LIGHT_OFF,
        ...
        Scene(
            ...
            name="Gaming Mode",
            description="Console plug on, TV on, Govee RGB reactive, dim ambient",
            actions=[
                AutomationAction(action_type=ActionType.BLIND_CLOSE,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(action_type=ActionType.DEVICE_ON,
                ...
                AutomationAction(
                    action_type=ActionType.LIGHT_DIM,
                    target_room_id="living-room",
                    parameters={"brightness": 15, "color": "blue"},
                ),
            ],
            room_id="living-room",
        ...
        Scene(
            ...
            name="Relax Mode",
            description="Warm dim lights, blinds closed, TV off — wind-down",
            actions=[
                AutomationAction(action_type=ActionType.BLIND_CLOSE,
                                 target_device_id="blind-ryse-01"),
                AutomationAction(action_type=ActionType.DEVICE_OFF,
                ...
                AutomationAction(
                    action_type=ActionType.LIGHT_DIM,
                    target_room_id="living-room",
                    parameters={"brightness": 20, "color": "warm"},
                ),
                AutomationAction(
                    action_type=ActionType.LIGHT_DIM,
                    target_room_id="bedroom-master",
                    parameters={"brightness": 15, "color": "warm"},
                ),
            ],
            tags=["evening", "wind_down"],
        ),
    ]
