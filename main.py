...
Usage:
    ...
    python main.py --db-logs             # Query all system logs
    python main.py --db-logs cfo         # Query logs for a specific agent
    python main.py --db-crawls           # Query crawl bot records
    python main.py --db-transactions     # Query financial transactions
    python main.py --db-accounts         # Show financial accounts from database
    python main.py --db-codes            # Query system codes
    python main.py --db-search "text"    # Full-text search across logs and transactions
...
def main() -> None:
    ...
    # Handle database commands early (before full agent init if possible)
    db_commands = (args.db or args.db_init or args.db_logs is not None
                   or args.db_crawls is not None or args.db_transactions is not None
                   or args.db_accounts or args.db_codes is not None
                   or args.db_search or args.db_spending or args.db_net_worth)
    if db_commands:
